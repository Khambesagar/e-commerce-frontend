    ...
    useEffect(() => {
        const adminData = async () => {
            try {
                ...
                const watchData = res.data.filter((data) => data.category === "watch");
    ...
    return (
        <>
            ...
            <div className='max-w-screen-2xl container mx-auto md:px-20 px-4 m-3 bg-white  h-[100vh]'>
                <h1 className=' text-2xl font-semibold text-center md:text-3xl underline text-blue-900 p-2'>Watches</h1>
